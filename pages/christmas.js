...
let christmas = (props) => (
  <Layout>
    <div className="page">
      <h1 className="heading">Holiday Jokes</h1>
...
christmas.getInitialProps = async function () {
  // Fetch the data using an async function called getInitialProps
  const res = await fetch(
    "https://v2.jokeapi.dev/joke/christmas?type=twopart&format=json&lang=en&amount=5&blacklistFlags=nsfw,racist,sexist,explicit"
  );
